...
### Changed
- Cleaned up touch screen configuration in `platformio.ini`.
- Set `TOUCH_CS=-1` to properly disable touch screen and eliminate compiler warnings.
- Removed commented-out touch screen definitions for cleaner configuration.
